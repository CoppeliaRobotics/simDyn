...
{
    return("Bullet v2.83.7");
}

bool CRigidBodyContainerDyn::_bulletContactCallback(btManifoldPoint& cp,const btCollisionObjectWrapper* colObjWrap0,int partId0,int index0,const btCollisionObjectWrapper* colObjWrap1,int partId1,int index1)
{
